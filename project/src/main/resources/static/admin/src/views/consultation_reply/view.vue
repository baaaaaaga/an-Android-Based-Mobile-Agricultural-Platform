	...
	<el-main class="bg edit_wrap comtable_e">
		...
		<el-row class="row_ce"> 
							...
							<el-form-item label="咨询编号" prop="consultation_number">
							  ...
							  v-if="(form['consultation_reply_id'] && $check_field('set','consultation_number')) || (!form['consultation_reply_id'] && $check_field('add','consultation_number'))" :disabled="disabledObj['consultation_number_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','consultation_number')">{{form['consultation_number']}}</div>
							...
							<el-form-item label="农户商家" prop="farmers_merchants">
																<el-select v-if="(form['consultation_reply_id'] && $check_field('set','farmers_merchants')) || (!form['consultation_reply_id'] && $check_field('add','farmers_merchants'))" id="farmers_merchants" v-model="form['farmers_merchants']" :disabled="disabledObj['farmers_merchants_isDisabled']">
					...
					<div slot="label">
						...
						商家名称
							  ...
							  v-if="(form['consultation_reply_id'] && $check_field('set','business_name')) || (!form['consultation_reply_id'] && $check_field('add','business_name'))" :disabled="disabledObj['business_name_isDisabled']"></el-input>
					...
					<div slot="label">
						...
						v-if="(form['consultation_reply_id'] && $check_field('set','contact_number')) || (!form['consultation_reply_id'] && $check_field('add','contact_number'))">
					</el-input>
					...
					<div slot="label">
						...
						商家地址
							  ...
							  v-if="(form['consultation_reply_id'] && $check_field('set','business_address')) || (!form['consultation_reply_id'] && $check_field('add','business_address'))" :disabled="disabledObj['business_address_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','business_address')">{{form['business_address']}}</div>
							...
							<el-form-item label="咨询日期" prop="date_of_consultation">
											<el-date-picker :disabled="disabledObj['date_of_consultation_isDisabled']" v-if="(form['consultation_reply_id'] && $check_field('set','date_of_consultation')) || (!form['consultation_reply_id'] && $check_field('add','date_of_consultation'))" id="date_of_consultation"
					...
					<div v-else-if="$check_field('get','date_of_consultation')">{{form['date_of_consultation']}}</div>
							...
							<el-form-item label="咨询用户" prop="consulting_users">
																<el-select v-if="(form['consultation_reply_id'] && $check_field('set','consulting_users')) || (!form['consultation_reply_id'] && $check_field('add','consulting_users'))" id="consulting_users" v-model="form['consulting_users']" :disabled="disabledObj['consulting_users_isDisabled']">
						...
						v-if="(form['consultation_reply_id'] && $check_field('set','consulting_content')) || (!form['consultation_reply_id'] && $check_field('add','consulting_content'))" :disabled="disabledObj['consulting_content_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','consulting_content')">{{form['consulting_content']}}</div>
							</el-form-item>
			</el-col>
								<el-col v-if="$check_field('get','reply_content') || $check_field('add','reply_content') || $check_field('set','reply_content')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
						...
						v-if="(form['consultation_reply_id'] && $check_field('set','reply_content')) || (!form['consultation_reply_id'] && $check_field('add','reply_content'))" :disabled="disabledObj['reply_content_isDisabled']"></el-input>
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item v-if="$check_action('/consultation_reply/view','set') || $check_action('/consultation_reply/view','add') || $check_option('/consultation_reply/table','examine')">
