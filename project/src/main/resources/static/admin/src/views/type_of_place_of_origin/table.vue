		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row class="rows row1">
					...
					<el-form-item label="产地类型">
									<el-input v-model="query.type_of_place_of_origin"></el-input>
								</el-form-item>
				</el-col>
				</el-row>
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="$check_action('/type_of_place_of_origin/table','del') || $check_action('/type_of_place_of_origin/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/type_of_place_of_origin/table','set') || $check_action('/type_of_place_of_origin/view','set') || $check_action('/type_of_place_of_origin/view','get') 
						" >
