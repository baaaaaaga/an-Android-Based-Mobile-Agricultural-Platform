		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row class="rows row1">
					...
					<el-form-item label="分享类型">
									<el-select v-model="query.share_type">
	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="$check_action('/experience_sharing/table','del') || $check_action('/experience_sharing/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
				...
				<el-table-column prop="title" @sort-change="$sortChange" label="标题" 				v-if="$check_field('get','title')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/experience_sharing/table','set') || $check_action('/experience_sharing/view','set') || $check_action('/experience_sharing/view','get') 
						" >
