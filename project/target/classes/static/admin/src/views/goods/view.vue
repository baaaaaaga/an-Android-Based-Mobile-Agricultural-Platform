		...
		<el-form ref="form" :model="form" status-icon label-width="70px">
			...
			<el-col :xs="24" :sm="24" :lg="24" v-show="!form.source_table" style="text-align: center;" class="el_form_btn_warp">
				...
				<el-button @click="cancel()">取消</el-button>
						...
						<!-- 农产品 -->
			<diy_agricultural_products v-if="form.source_table === 'agricultural_products'" :query="{agricultural_products_id:form.source_id}" :form_goods="form" :func_check="checkForm" :func_submit="submit" ></diy_agricultural_products>
...
<script>
	import mixin from "../../mixins/page.js";
				import diy_agricultural_products from "../../components/diy/diy_agricultural_products.vue";
								
	export default {
		mixins: [mixin],
		components:{
						diy_agricultural_products,
										},
		data() {
			return {
				field: "goods_id",
