	...
	<el-main class="bg edit_wrap comtable_e">
		...
		<el-row class="row_ce"> 
							...
							<el-form-item label="分享类型" prop="share_type">
															<el-input id="share_type" v-model="form['share_type']" placeholder="请输入分享类型"
							  v-if="(form['share_type_id'] && $check_field('set','share_type')) || (!form['share_type_id'] && $check_field('add','share_type'))" :disabled="disabledObj['share_type_isDisabled']"></el-input>
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item v-if="$check_action('/share_type/view','set') || $check_action('/share_type/view','add') || $check_option('/share_type/table','examine')">
